...
export const MyProfile = () => {
  ...
  const fetchUserEmail = async () => {
    try {
      ...
      if (!userDoc.exists) throw { name: "noUser" };
            ...
            <div className="flex w-full justify-center">
              <div className="relative">
                <img
                  ...
                  className="absolute -m-16 -ml-20 h-[150px] w-[150px] max-w-[150px]  rounded-full border-none object-cover align-middle shadow-xl lg:-ml-16"
                />
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center">
              <div className="w-full px-4">
                <p className="mb-4 font-light leading-relaxed text-slate-600">
                  © This is a social media platform where you as a user can add
                  various types of pictures that we provide to your collection.
                </p>
                <Link
                  to={"/update-profile"}
